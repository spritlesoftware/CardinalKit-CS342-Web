          ...
          { visiblePages.map((page, index, array) => {
            return (
              ...
              <PageButtonComponent
                ...
                className={
                  activePage === page
                    ? "Table__pageButton Table__pageButton--active text-center px-4 py-1 m-2 px-3 py-1 text-white transition-colors duration-150 bg-red-700 shadow-lg border border-r-0 focus:outline-none focus:border-none focus:shadow-outline-purple"
                    : "Table__pageButton text-gray-700 text-center bg-gray-400 px-4 py-1 m-2 px-3 py-1"
                }
